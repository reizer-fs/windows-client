...
echo "Windows 10 detected, applying custom settings..."
rem Show File extension
reg add HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced /v HideFileExt /t REG_DWORD /d 0 /f
rem Hide File extension
rem reg add HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced /v HideFileExt /t REG_DWORD /d 1 /f

REM Copy Custom Soft
md "C:\Program Files (x86)\Softs" >nul 2>&1
copy Components\putty.exe "C:\Program Files (x86)\Softs\" 

REM DISABLE HIBERNATION
powercfg -h off

REM ADDED TO TASKBAR
cscript Scripts\PinItem.vbs /taskbar /item:"C:\Program Files (x86)\Softs\putty.exe"
...
REM RUN INSTALL
Powershell.exe -executionpolicy remotesigned -File Debloater.ps1
